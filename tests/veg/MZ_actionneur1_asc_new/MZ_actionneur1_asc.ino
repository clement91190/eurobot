...
{ 
  ...
  Ascenseur_D.setMaxSpeed(3000);
  Ascenseur_G.setAcceleration(200);
  Ascenseur_D.setAcceleration(200);
  ...
  BRAS_D_Hz.writeMicroseconds(1800); // rangement
  BRAS_G_Hz.writeMicroseconds(1000); // rangement
...
{ 
 ...
 if( tm_diff >= READ_TM ) {
  ...
  if (Serial.available() > 0) {
     ...
     case 'n':
       BRAS_G_Hz.writeMicroseconds(2200); // rangement
     ...
     case 's':
       BRAS_D_Hz.writeMicroseconds(600); // rangement
       Serial.println("BRAS DROITE horizontal rangement");        
       break;  
     
       // BRAS DROITE descente
     case 't':
       distanceCM = 0;
       posASC_D = int(500*distanceCM/17.5*facteurMicrostepping);
       Ascenseur_D.moveTo(posASC_D);
       Ascenseur_G.moveTo(-posASC_D);
       Serial.println("descente ascenseur init/rangement");        
       break;
       
       // BRAS DROITE descente
     case 'u':
       distanceCM = 22.8;
       //posASC_D = int(1000*distanceCM/17.5);
       posASC_D = int(500*distanceCM/17.5*facteurMicrostepping);
       //posASC_D = int(16000*distanceCM/19);
       Ascenseur_D.moveTo(posASC_D);
       Ascenseur_G.moveTo(-posASC_D);
       Serial.println("descente ascenseur chope par terre");        
       break; 
     ...
     case 'v':
       ...
       Ascenseur_D.moveTo(posASC_D);
       Ascenseur_G.moveTo(-posASC_D);
       Serial.println("descente ascenseur cooperation dessus up");        
       break;
      
      // BRAS DROITE coop down
     case 'w':
       distanceCM = 19;
       //posASC_D = int(16000*distanceCM/19);
       //posASC_D = int(1000*distanceCM/17.5);
       ...
       Ascenseur_D.moveTo(posASC_D);
       Ascenseur_G.moveTo(-posASC_D);
       Serial.println("descente ascenseur cooperation dessous down");        
       break;  
     
        // BRAS DROITE stand by
     case 'x':
       distanceCM = 4;
       //posASC_D = int(16000*distanceCM/19);
       //posASC_D = int(1000*distanceCM/17.5);
       ...
       Ascenseur_D.moveTo(posASC_D);
       Ascenseur_G.moveTo(-posASC_D);
       Serial.println("descente ascenseur stand by");        
       break;
