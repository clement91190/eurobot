...
def get_mission(com_state_factory, ind=1):
    return Mission(" Pose torche ", Coord(700, 800, 90), MAEPoseTorche(com_state_factory))


class MAEPoseTorche(MAE):
...
# rajoute transition from actionneur
        ...
        recule.add_afini_transition(tape)
        recule.add_bloc_transition(tape)

        tape.add_instant_transition(out)
...
if __name__ == "__main__":
    ...
    mae = MAEPoseTorche(ComStateFactory(com))
